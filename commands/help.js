...
module.exports.run = async (msg, agrs) => {
    ...
    .addField('__AH et aussi :__', 'Faite moi part des ajouts que vous voudiez voir sur ce bot et aussi des bugs que vous trouvez par mp (<@464119931282391061>) ou sur GitHub (https://github.com/Syudagye/PookieBot/issues) !', true)
    )
}
